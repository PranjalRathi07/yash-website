					...
					<div className='hidden lg:flex flex-col gap-12 lg:col-span-3 sticky top-32 h-fit'>
						<div>
							...
							<ul className='space-y-4 font-sans text-sm text-on-surface-variant'>
								<li>
									<a href='#washing-silk' className='hover:text-primary transition-colors'>
										Washing Silk Vastra
									</a>
								</li>
								<li>
									<a href='#jewelry-preservation' className='hover:text-primary transition-colors'>
										Jewelry Preservation
									</a>
								</li>
								<li>
									<a href='#mukut-care' className='hover:text-primary transition-colors'>
										Mukut Care
									</a>
								</li>
								<li>
									<a href='#altar-storage' className='hover:text-primary transition-colors'>
										Altar Storage
									</a>
								</li>
							</ul>
					...
					<div className='lg:col-span-9 flex flex-col gap-16'>
									...
									<div className='w-full md:w-1/2'>
										...
										<ul className='space-y-4'>
											...
											<li className='flex items-start gap-3'>
												...
												<span className='font-sans text-sm text-on-surface-variant'>
													Avoid wringing or twisting the fabric; gently squeeze out
													water.
												</span>
											</li>
											<li className='flex items-start gap-3'>
												...
												<span className='font-sans text-sm text-on-surface-variant'>
													Dry flat in shade, away from direct sunlight to prevent
													fading.
												</span>
											</li>
										</ul>
						...
						<section className='scroll-mt-32' id='jewelry-preservation'>
							...
							<div className='bg-primary text-surface rounded-2xl p-10 overflow-hidden relative'>
								<p className='font-sans text-base text-surface/90 mb-8 leading-relaxed'>
									...
									plating. Protect their celestial glow by following these steps.
								</p>
						...
						<section className='scroll-mt-32' id='mukut-care'>
							...
							<div className='bg-surface-container-low rounded-xl border-[0.5px] border-tertiary/20 p-10'>
								...
								<p className='font-sans text-base text-on-surface-variant mb-6 leading-relaxed'>
									...
									delicate and often uses organic materials like peacock feathers.
								</p>
								<div className='space-y-4'>
									<div className='flex gap-4 items-center p-4 bg-surface rounded-xl border-[0.5px] border-tertiary/10'>
										...
										<span className='font-sans text-sm text-on-surface-variant'>
											Use a soft-bristled brush to remove dust from feather tips.
										</span>
									</div>
									<div className='flex gap-4 items-center p-4 bg-surface rounded-xl border-[0.5px] border-tertiary/10'>
										<span className='material-symbols-outlined text-tertiary'>
								...
								<div className='flex flex-col md:flex-row gap-8'>
									<div className='md:w-3/5'>
										<p className='font-sans text-base text-on-surface-variant mb-8 leading-relaxed'>
											A sacred space for storage ensures that the garments remain
											fresh and protected from environmental factors like humidity
											and insects.
										</p>
						...
						<section
							...
							<p className='font-sans text-base text-on-surface-variant mb-10 max-w-xl mx-auto leading-relaxed'>
								Our artisans are here to guide you. Contact our Seva support team
								for personalized advice on cleaning and restoration.
							</p>
