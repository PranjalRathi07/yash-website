...
const Footer = () => {
	...
	return (
		<footer className='bg-primary pt-28 pb-12 px-8 flex flex-col justify-between gap-12 border-t border-tertiary/20 min-h-[calc(100vh-80px)]'>
			<div className='w-full px-8 md:px-16 lg:px-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16'>
				<div className='flex flex-col'>
					<h2 className='font-serif text-6xl font-bold text-tertiary mb-6 leading-tight'>
						Krishna
						<br />
						Vasanam
					</h2>
			...
			<div className='w-full px-8 md:px-16 lg:px-24 pt-8 border-t border-tertiary/10 mt-12 flex justify-center text-center'>
